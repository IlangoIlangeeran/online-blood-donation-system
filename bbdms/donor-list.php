...
<head>
	<title>Daraz seller Management System | product seller List </title>
	<!-- Meta tag Keywords -->
	...
	<div class="breadcrumb-agile">
		<div aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Product Seller List</li>
			</ol>
		</div>
	</div>
	<!-- //page details -->
	...
	<div class="agileits-contact py-5">
		<div class="py-xl-5 py-lg-3">
			...
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">Product Seller List</h3>
				<span>
